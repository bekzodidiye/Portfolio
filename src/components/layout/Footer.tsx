  ...
  return (
    <footer className="border-t border-slate-200 bg-slate-100/80 backdrop-blur-md relative z-10 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div className="flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-emerald-700 text-xs font-mono shadow-xs">
          ...
          <span className="text-[11px] text-slate-500 hidden sm:inline">99.9% Uptime</span>
        </div>
